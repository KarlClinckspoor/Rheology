...
class Settings:
    def __init__(self, debug=False):
        self.valid_settings = ['DEBUG', 'INLINE_GRAPHS', 'LIN_SORTING_METHOD',
                               ...
                               'DO_NL', 'TREAT_ALL', 'EXT', 'PREV_EXTRACTED']
        self.valid_options_lin_sorting = ['by_error', 'by_error_length']
        self.valid_options_nl_sorting = ['eta_0', 'overall']
        ...
        try:
            ...
            self.LIN_SORTING_METHOD = 'by_error_length'  # by_error, by_error_length
            self.NL_FITTING_METHOD = 'Carreau'  # Carreau, Cross, Carreau-Yasuda
            self.NL_SORTING_METHOD = 'overall'  # eta_0, overall
    ...
    def print_settings(self):
        ...
        for param in self.valid_settings:
            ...
            if param == 'LIN_SORTING_METHOD':
                print(': Options= ', end='')
                print(*self.valid_options_lin_sorting, sep=' | ')
            if param == 'NL_FITTING_METHOD':
                print(': Options= ', end='')
                print(*self.models, sep=' | ')
            if param == 'NL_SORTING_METHOD':
                print(': Options= ', end='')
